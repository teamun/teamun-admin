teamunApp.controller('ActivityDetailCtrl', ['$scope', '$state', '$stateParams', '$location', 'toaster', '$timeout', 'ActivityService', function($scope, $state, $stateParams, $location, toaster, $timeout, ActivityService) {
